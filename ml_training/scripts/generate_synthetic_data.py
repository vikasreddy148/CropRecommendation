...
class SyntheticDataGenerator:
    ...
    CROP_REQUIREMENTS = {
        ...
        'Chickpea': {
            ...
            'n_min': 40, 'p_min': 60, 'k_min': 80,
            'moisture_min': 30,
            'temperature_min': 17, 'temperature_max': 21,
            'rainfall_min': 60,
            'season': ['rabi'],
            'avg_yield': 1500,
        },
        ...
        'Mungbean': {
            ...
            'n_min': 20, 'p_min': 40, 'k_min': 20,
            'moisture_min': 40,
            'temperature_min': 27, 'temperature_max': 29,
            'rainfall_min': 35,
            'season': ['kharif', 'zaid'],
            'avg_yield': 1000,
        },
        ...
        'Mango': {
            ...
            'n_min': 20, 'p_min': 20, 'k_min': 30,
            'moisture_min': 50,
            'temperature_min': 27, 'temperature_max': 35,
            'rainfall_min': 90,
            'season': ['year_round'],
            'avg_yield': 10000,
        },
        ...
        'Muskmelon': {
            ...
            'n_min': 100, 'p_min': 20, 'k_min': 50,
            'moisture_min': 50,
            'temperature_min': 28, 'temperature_max': 35,
            'rainfall_min': 20,
            'season': ['zaid'],
            'avg_yield': 18000,
        },
        'Apple': {
            ...
            'n_min': 20, 'p_min': 130, 'k_min': 200,
            'moisture_min': 60,
            'temperature_min': 21, 'temperature_max': 24,
            'rainfall_min': 100,
            'season': ['year_round'],
            'avg_yield': 15000,
        },
        ...
        'Papaya': {
            'ph_min': 5.5, 'ph_max': 7.0,
            'n_min': 40, 'p_min': 50, 'k_min': 50,
            'moisture_min': 60,
            'temperature_min': 23, 'temperature_max': 45,
            'rainfall_min': 150,
            'season': ['year_round'],
            'avg_yield': 40000,
        },
        ...
        'Jute': {
            ...
            'moisture_min': 70,
            'temperature_min': 23, 'temperature_max': 25,
            'rainfall_min': 150,
            'season': ['kharif'],
            'avg_yield': 2500,
        },
        'Coffee': {
            'ph_min': 6.0, 'ph_max': 6.5,
            'n_min': 100, 'p_min': 30, 'k_min': 30,
            'moisture_min': 60,
            'temperature_min': 23, 'temperature_max': 28,
            'rainfall_min': 140,
            'season': ['year_round'],
            'avg_yield': 800,
        },
